...
include '../../modele/navigation_facettes/facettes_achat.php';
...
if ($_POST && count($_POST)) {
    ...
    if(
        isset($_POST["etat"]) &&
        count($_POST) && 
        array_key_exists('etat', $_POST) &&
        (!empty($_POST["etat"])) &&
        is_string($_POST["etat"]) 
    ){
    ...
    if (
        isset($_POST["triachat"]) &&
        count($_POST) && 
        array_key_exists('triachat', $_POST) &&
        (!empty($_POST["triachat"])) &&
        is_string($_POST["triachat"])
    ){

        if($_POST["triachat"] === 'achat_prix_croissant'){
            prixCroissant();
        } else if ($_POST["triachat"] === 'achat_prix_decroissant') {
            prixDecroissant();
        } else if ($_POST["triachat"] === 'achat_annee_croissant'){
            anneeCroissant();
        } else if ($_POST["triachat"] === 'achat_annee_decroissant'){
            anneeDecroissant();
        }
